...
class LocalSolverCaptcha(BaseCaptcha):
    """Solve Turnstile via local api_solver service (Camoufox/patchright)"""
    ...
    def start_solver(headless: bool = True, browser_type: str = "camoufox",
                     port: int = 8889) -> None:
        """Start local solver service in a background thread"""
        ...
        for _ in range(20):
            ...
            try:
                ...
                pass
        raise RuntimeError("LocalSolver startup timed out")
