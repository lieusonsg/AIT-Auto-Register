  ...
  return (
    <section>
      ...
      <p className="mt-1 text-sm text-[var(--text-muted)]">
        Customize supported executors, identity modes, and OAuth providers per platform.
      </p>
          ...
          return (
            ...
            >
              ...
              <div className="space-y-3">
                <div>
                  <p className="mb-2 text-xs text-[var(--text-muted)]">Executor</p>
                ...
                <div>
                  <p className="mb-2 text-xs text-[var(--text-muted)]">Identity Mode</p>
                ...
                <div>
                  <p className="mb-2 text-xs text-[var(--text-muted)]">OAuth Provider</p>
                  <div className="flex flex-wrap gap-4">
