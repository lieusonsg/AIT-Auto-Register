        ...
        <Card className="bg-[var(--bg-pane)]/60">
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-[var(--border-soft)] bg-[var(--bg-pane)]/45 px-3.5 py-2.5 text-xs leading-5 text-[var(--text-secondary)]">
              Support single proxy entry or multi-line batch import. Region tags are saved together for filtering and entry/exit identification.
            </div>
            ...
            {proxies.length === 0 && (
              <tr>
                <td colSpan={5} className="px-4 py-8">
                  <div className="empty-state-panel">The proxy pool is empty. You can add one from the left or batch import.</div>
                </td>
              </tr>
            )}
            {proxies.map(p => (
