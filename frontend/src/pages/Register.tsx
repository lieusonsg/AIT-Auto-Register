      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1.45fr)_340px]">
        <div className="space-y-4">
              ...
              {form.identity_provider === 'oauth_browser' && (
                <>
                  ...
                  <p className="text-xs text-[var(--text-muted)]">
                    For third-party accounts using background browser automation, it is recommended to configure Chrome Profile or Chrome CDP to reuse the local logged-in browser session.
                  </p>
                </>
              )}
            </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {mailboxProviderOptions.length > 0 ? (
                  <Select label="Mail Service" k="mail_provider" options={mailboxProviderOptions} />
                ) : (
                  <div className="rounded-2xl border border-amber-500/20 bg-amber-500/10 px-4 py-3 text-sm text-amber-200">
                    No mailbox provider is currently enabled. Please go to Settings to add and enable a default mailbox provider.
                  </div>
                )}
          ...
          {smsProviderOptions.length > 0 && (
            <Card>
              <CardHeader><CardTitle>SMS Configuration</CardTitle></CardHeader>
              <CardContent className="space-y-4">
                {optionsError && (
                  <div className="rounded-2xl border border-red-500/20 bg-red-500/10 px-4 py-3 text-sm text-red-300">
                    {optionsError}
